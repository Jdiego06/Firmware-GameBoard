...
C_SRCS += \
../drivers/custom/JOYSTICK/JOYSTICK.c 

OBJS += \
./drivers/custom/JOYSTICK/JOYSTICK.o 

C_DEPS += \
./drivers/custom/JOYSTICK/JOYSTICK.d 


# Each subdirectory must supply rules for building sources it contributes
drivers/custom/JOYSTICK/%.o: ../drivers/custom/JOYSTICK/%.c
	@echo 'Building file: $<'
